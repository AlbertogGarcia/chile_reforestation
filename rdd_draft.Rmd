...
We see that heapers are much less likely to work with an extensionist or consultant, submit a digital application, and actually receive the payment (row 1). They do not clearly differ on the enrolled area (ha), the total payment requested, or the probability of pursuing timber production objectives (row 2). This may reflect the lack of resources that heapers have, which leads to low follow-through. 
...
In this section, I use the matched sample to compare properties within the manupulable zone that were truly below the 200 ha threshold vs. those that under reported their property size. 
