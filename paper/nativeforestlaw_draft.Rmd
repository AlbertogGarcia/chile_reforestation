...
Political processes often lead policymakers to design programs aimed at multiple objectives [@tinbergen]. PES programs are no different and because forest cover and poverty are correlated, they are frequently designed to achieve social development goals in addition to environmental gains [@zilberman2008; @lipper2009; @rios2011]. This is done by targeting payments toward landowners or communities with the greatest need for poverty alleviation [@wunder_payments_2008]. However, subsidies that reflect political processes have the potential to undermine environmental benefits [@jack2008], and this strategy has proven to create tradeoffs in many payments for avoided deforestation programs. 

The effectiveness of payments for avoided deforestation is driven by the presence of deforestation risk [@alix-garcia_payment_2014]. Targeting payments toward households that are unlikely to deforest in the absence of payments generates relatively little additional forest cover relative to the no-payment scenario [@pfaff1999]. For example, @cisneros_bolsa_2022 show that Brazil's Bolsa Floresta targeted payments toward areas where deforestation was already low, reducing the avoided deforestation achieved by the program. It is well documented that poverty is associated with lower levels of deforestation [@busch2017]. Because of this broad finding, it has often been shown that enrollment of landowners in high-poverty areas generates relatively fewer environmental benefits [@pfaff2007]. Further, credit constrained and low-income landowners may be prone to leakage, meaning that they deforest unenrolled land upon enrolling part of the property [@jack_leakage_2017; @alix-garcia_leakage_2012].
...
Figure \@ref(fig:descriptive-trends) shows the average change in tree cover in the 10 years leading up to enrollees' application. We see that the typical enrollee was increasing tree cover on their property prior to their application to the subsidy competition. This broad finding holds across different subsamples of enrollees, however, some groups were increasing tree cover at greater rates prior to enrollment. The top left panel shows that those with above median values of $social_i$, the application's social score, were increasing forest cover at a relatively lower rate than those with low social scores. The bottom panel suggests that properties within high-poverty comunas were also producing new forest cover at relatively lower rates prior to enrollment. This suggests that perhaps the most marginalized landowners were producing the least new forest cover prior to enrollment. This may suggest that low-income or indigenous smallholders had relatively higher costs to producing forest cover. 
...
```{r descriptive-trends,  fig.show="hold", fig.pos="H", out.width = '100%', fig.cap = "This figure shows tree cover trends of enrollees in the years leading up to their application and enrollment in the Native Forest Law subsidy competition.", fig.width = 10, fig.height = 4, echo=FALSE}
