---
title: Heterogeneous land use impacts of Chilean payments for reforestation
...
<!-- TODO: -->
<!-- Discuss the issues with monocultures and the context of the native forest law -->
<!-- Matching diagnostics -->
<!-- Incorporate poverty metrics -->

\begin{outline}
\1 Intro
\1 Conceptual framework
\2 avoided deforestation vs. reforestation
\1 Chile's afforestation subsidies
\1 Methods
\1 Results
\1 Conclusion
\end{outline}
...
\textbf{TO DO:}
\begin{itemize}
\item put standard $ATT$ estimates in appendix
\item conceptual framework
\item redo intro to fit with story
\item add in comunal poverty estimates
\item redo land use estimates x100
\end{itemize}
...
I first measure the impact of the program on all enrolled properties. This is the effect of being granted enrollment in the program and having the project and subsequent payment approved, regardless of whether the landowner does ultimately follow through. Figure \@ref(fig:enrolled-dynamic) shows that the NDVI on the characteristic awarded property steadily increases through time on average relative to the control properties following treatment.
