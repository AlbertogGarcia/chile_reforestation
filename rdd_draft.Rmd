...
discontinuity_main <- NFL_df %>%
  ...
  mutate(received_bonus = as.numeric(ifelse(rptpro_tiene_bonificacion_saff == "Si", 1, 0)),
         ...
         round_heaper = (property_size %% 10 == 0)*1,
