...
did.mgmt <- att_gt(yname="EVI2",
                     ...
                     gname="first.treat",
                     est_method = "reg",
                     xformla=~  smallholder+forest + plantation + baresoil + pasture +shrub + urban +water+ slope +lat+  elev  + area_ha  +road_dist ,
...
``` {r did smallholder, echo = FALSE, message = FALSE, warning = FALSE, include = TRUE, eval = TRUE}
...
# smallholder*treat
# > did.mgmt.es$overall.att
# [1] 0.009475155
# > did.mgmt.es$overall.se
# [1] 0.006829084
# treat 
did.mgmt.ovr <- aggte(did.mgmt, na.rm=TRUE, type = "simple")
# smallholder*treat
# > did.mgmt.ovr$overall.att
# [1] 0.008398502
# > did.mgmt.ovr$overall.se
# [1] 0.006527092
# treat 
