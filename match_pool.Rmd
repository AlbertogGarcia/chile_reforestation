...
variabler <- function(df){
  return_df <- df %>%
    mutate(treat=0,
         ...
         water = c_15,
         urban = c_16)%>%
  select(objectid, geometry.x, treat, first.treat, area_ha, road_dist, lat, long, slope, elev, treat, forest, plantation, water, shrub, baresoil, pasture, urban, y_2005:y_2020, evi_2005:evi_2020)
