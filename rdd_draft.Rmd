...
The second path would overcome the heaping to conduct a regression discontinuity design analysis. I still believe this is possible, as several papers in the economics literature have sought to overcome and analyze this issue in similar settings. @barreca2016 explore heaping in the context of birth weights. While extremely unlikely in "nature", reports show heaping at perfect 100 gram levels. They conduct monte carlo analyses to show that dropping data at heap points provides unbiased estimates of the LATE. 
