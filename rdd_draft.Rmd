...
I use both parametric and nonparametric approaches in order to ensure the research design is robust. For the parametric case, we create an instrumental variable that indicates if a property is above or below the smallholder eligibility threshold. Note that this variable should easily meet the necessary conditions for a successful instrument:

Relevance: The cutoff determines smallholder eligibility

Exclusion: The cutoff impacts outcomes of interest only through smallholder eligibility

Exogeneity: Unobserved confounders between smallholder eligibility and outcomes are unrelated to the cutoff
