...
This table shows the progress of the spatial join and metrics that assess its validity. 
...
kable(summary_tab2, 
      "latex", 
      booktabs =T, 
      caption = "spatial join statistics continued.."
      ) %>%
  kable_styling(latex_options = "hold_position", font_size = 6)
...
\begin{table}[h]
\begin{tabular}{c|c}
total_projects & total Native Forest Law projects\\
total_stands & total Native Forest Law stands\\
joined_projects & Native Forest Law projects joined with CIREN properties\\
joined_stands & Native Forest Law stands joined with CIREN properties\\
rol_match & proportion of stands with matching rol id\\ 
similar_rol & proportion of stands with matching first part of rol id\\
